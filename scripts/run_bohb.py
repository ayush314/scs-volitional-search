...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run BOHB under a fixed seed-level trial budget.")
    parser.add_argument("--output-dir", default="results/bohb")
...
def main() -> None:
    ...
    optimizer = replace(OptimizerConfig(algorithm="bohb"), seed_trial_budget=args.seed_trial_budget)
